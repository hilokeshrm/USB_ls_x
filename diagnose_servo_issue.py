#!/usr/bin/env python3
"""
Diagnostic script to troubleshoot servo control issues
"""
...
def main():
    print("=" * 60)
    print("ROBOT SERVO CONTROL DIAGNOSTIC")
    print("=" * 60)
    print()
    
    # Step 1: Test connection
    print("Step 1: Testing TCP/IP connection...")
    ...
    if not robot.connect(debug=True):
        ...
        print("  2. Verify IP address: " + ROBOT_IP)
        print("  3. Check both devices are on same Wi-Fi network")
        print("  4. Try: ping " + ROBOT_IP)
        return False
    ...
    print("Note: You had motor ID 16 in your script - that might be invalid!")
    print("Valid motor IDs are typically 1-12 for your robot")
